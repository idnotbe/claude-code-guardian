# V1 Test Results (Round 2): Heredoc Fix Verification
...
### Comparison to V1 Round 1 (pre-implementation):
- Round 1: 10 passed, 21 failed (fixes not yet implemented)
- Round 2: **31 passed, 0 failed** (fixes implemented)
...
### Comparison to V1 Round 1:
- Round 1: 84 passed, 17 failed
- Round 2: **85 passed, 16 failed**
...
### Key observation: The heredoc test (`heredoc with ; should NOT split at ;`) that was in the Section 1 failure list in Round 1 has now PASSED, confirming the fix works end-to-end in the adversarial test suite.
...
| Suite | Runner | Passed | Failed | Errors | Delta from R1 |
|-------|--------|--------|--------|--------|---------------|
